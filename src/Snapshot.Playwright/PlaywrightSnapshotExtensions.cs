...
{
    public static SnapshotEngineBuilder UsePlaywright(
        this SnapshotEngineBuilder builder,
        Action<PlaywrightSnapshotOptions>? configure = null,
        ISnapshotLogger? logger = null)
    {
        ...
        return builder
            .UseLogger(logger)
            .UseRenderer(new PlaywrightSnapshotRenderer(options, logger));
    }
}
