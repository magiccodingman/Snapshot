...
internal sealed class CommandLine
{
    ...
    public IReadOnlyList<string> GetMany(string name) => _options.TryGetValue(name, out var values) ? values.Where(static value => value is not null).Cast<string>().ToArray() : [];
